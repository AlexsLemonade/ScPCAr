...
```
## [1] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/README.md"                                                           
## [2] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/single-cell_metadata.tsv"                    
## [3] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_celltype-report.html"
## [4] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_filtered.rds"        
## [5] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_processed.rds"       
## [6] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_qc.html"
```
...
```
## ScPCA dataset f5fa92aa-b2e2-4387-a842-b63430404468 created.
```

By default a new project will use SCE objects, but you can also specify `format = "anndata"` to create a dataset with AnnData objects instead.
*Once a dataset is created, you can not change the format, and must start fresh with a new dataset.*
...
```
## $id
## [1] "f5fa92aa-b2e2-4387-a842-b63430404468"
## 
## $format
...
```
## ScPCA dataset f5fa92aa-b2e2-4387-a842-b63430404468 processing started.
```
...
```
## Error:
## ! ScPCA dataset `f5fa92aa-b2e2-4387-a842-b63430404468` is not ready for download (status: processing). Use `get_dataset_status("f5fa92aa-b2e2-4387-a842-b63430404468")` to monitor progress. Alternatively, rerun `download_dataset() with `await_processing = TRUE` to wait for processing and download when complete.
```
...
```
## ℹ Waiting for dataset f5fa92aa-b2e2-4387-a842-b63430404468 to finish processing...
```

```
## Downloading f5fa92aa-b2e2-4387-a842-b63430404468_single-cell-experiment_2026-06-29.zip...
```

```
## Unzipping to scpca_data/f5fa92aa-b2e2-4387-a842-b63430404468_single-cell-experiment_2026-06-29...
```
