...
There are two main patterns for downloading data from the ScPCA Portal using `ScPCAr`: downloading pre-defined projects or constructing custom data sets.

- Project downloads contain all available samples for a given project
- Creating a custom dataset allows you to specify specific sets of samples, including samples from different projects
