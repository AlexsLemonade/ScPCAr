...
## [2] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_bulk_rna/SCPCP000001_bulk_metadata.tsv"                  
## [3] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_bulk_rna/SCPCP000001_bulk_quant.tsv"                     
## [4] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_celltype-report.html"
## [5] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_filtered.rds"        
## [6] "scpca_data/SCPCP000001_single-cell-experiment_2026-06-29/SCPCP000001_single-cell/SCPCS000001/SCPCL000001_processed.rds"
```
...
```
## ScPCA dataset 77dd00c6-50b7-48ed-8727-6f115c4c2d2e created.
```
...
```
## $id
## [1] "77dd00c6-50b7-48ed-8727-6f115c4c2d2e"
## 
## $format
...
```
## ScPCA dataset 77dd00c6-50b7-48ed-8727-6f115c4c2d2e processing started.
```
...
```
## Error:
## ! ScPCA dataset `77dd00c6-50b7-48ed-8727-6f115c4c2d2e` is not ready for download (status: processing). Use `get_dataset_status("77dd00c6-50b7-48ed-8727-6f115c4c2d2e")` to monitor progress. Alternatively, rerun `download_dataset() with `await_processing = TRUE` to wait for processing and download when complete.
```
...
```
## ℹ Waiting for dataset 77dd00c6-50b7-48ed-8727-6f115c4c2d2e to finish processing...
```

```
## Downloading 77dd00c6-50b7-48ed-8727-6f115c4c2d2e_single-cell-experiment_2026-06-29.zip...
```

```
## Unzipping to scpca_data/77dd00c6-50b7-48ed-8727-6f115c4c2d2e_single-cell-experiment_2026-06-29...
```
...
##  P ScPCAr               * 0.1.0     2026-06-29 [?] load_all()
