...
```
## ScPCA dataset 1b9f5d01-7ae1-4616-8bad-6a1862349c5e created.
```
...
```
## $id
## [1] "1b9f5d01-7ae1-4616-8bad-6a1862349c5e"
## 
## $format
...
```
## ScPCA dataset 1b9f5d01-7ae1-4616-8bad-6a1862349c5e processing started.
```
...
```
## Error:
## ! ScPCA dataset `1b9f5d01-7ae1-4616-8bad-6a1862349c5e` is not ready for download (status: processing). Use `get_dataset_status("1b9f5d01-7ae1-4616-8bad-6a1862349c5e")` to monitor progress. Alternatively, rerun `download_dataset() with `await_processing = TRUE` to wait for processing and download when complete.
```
...
```
## ℹ Waiting for dataset 1b9f5d01-7ae1-4616-8bad-6a1862349c5e to finish processing...
```

```
## Downloading 1b9f5d01-7ae1-4616-8bad-6a1862349c5e_single-cell-experiment_2026-06-29.zip...
```

```
## Unzipping to scpca_data/1b9f5d01-7ae1-4616-8bad-6a1862349c5e_single-cell-experiment_2026-06-29...
```
