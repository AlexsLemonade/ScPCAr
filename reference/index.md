...
- [`get_project_libraries()`](https://alexslemonade.github.io/ScPCAr/reference/get_project_libraries.md)
...
- [`set_dataset_email()`](https://alexslemonade.github.io/ScPCAr/reference/set_dataset_email.md)
